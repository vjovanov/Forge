...
trait NodeIdViewOps {
  ...
  def importNodeIdViewOps() {
    ...
    NodeIdViewOps {
      ...
      infix ("mapreduceChunks") ( (MInt ==> T,(T,T) ==> T, MInt==>MBoolean, MString) :: T, TNumeric(T), addTpePars=(T)) implements mapReduce((MInt,T), 0, ${e => $1(e)}, ${numeric_zero[T]}, ${(a,b) => $2(a,b)}, Some(${c => $3(c)}), ${$4} )
