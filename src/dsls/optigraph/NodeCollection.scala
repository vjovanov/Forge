...
trait NodeCollectionOps {
  ...
  /*
    ...
    2 - Bit Set
  */
  data(NodeCollection,("_type",MInt),("_dataHS",HashSet(MInt)),("_dataNDV",NodeDataView(MInt)),("_dataBS",GraphBitSet))

  static (NodeCollection) ("apply", Nil, MInt :: NodeCollection) implements allocates(NodeCollection,${nc_0},${hs_fake_alloc},${ndv_fake_alloc},${gbs_fake_alloc})
  ...
  NodeCollectionOps{
    ...
    compiler ("nc_getNodeDataView") (Nil :: NodeDataView(MInt)) implements getter(0, "_dataNDV")
