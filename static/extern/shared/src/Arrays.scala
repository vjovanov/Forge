...
trait ForgeArrayDefs {
  /* NUMA-aware arrays */
  abstract class NumaGhostCells
  case object ghostAll extends NumaGhostCells
  case object ghostNone extends NumaGhostCells
}

// Front-end
trait ForgeArrayOps extends Base with ForgeArrayDefs {
  /**
  ...
  def array_numa_empty[T:Manifest](len: Rep[Int], ghost: NumaGhostCells = ghostNone): Rep[ForgeArray[T]]
